...
export class ModuleComponent implements OnInit {
  ...
  @ViewChild('iconTemplate', { static: true }) iconTemplate!: TemplateRef<{ $implicit: ModuleSelectModel }>;
  @ViewChild('estadoTemplate', { static: true }) estadoTemplate!: TemplateRef<{ $implicit: ModuleSelectModel }>;
