...
import { RoleUserCreateModel, RoleUserSelectModel } from '../../models/role-user.models';
import { RolUserService } from '../../services/role-user/role-user.service';
...
export class RoleUserComponent implements OnInit {
  ...
  rolUsers: RoleUserSelectModel[] = [];
  columns: TableColumn<RoleUserSelectModel>[] = [];
  ...
  onCreateNew() {
    forkJoin({
      ...
      const initial: RoleUserCreateModel = {
      ...
      import('../../../../shared/components/forms/form-dialog/form-dialog.component').then(m => {
        ...
        dialogRef.afterClosed().subscribe((result: any) => {
          ...
          const payload: RoleUserCreateModel = {
  ...
  // EDIT
  onEdit(row: RoleUserSelectModel) {
    const id = row.id;
  ...
  // DELETE
  async onDelete(row: RoleUserSelectModel) {
  ...
  onView(row: RoleUserSelectModel) {
  }
}
